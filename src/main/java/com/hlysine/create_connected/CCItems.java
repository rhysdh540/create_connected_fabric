...
public class CCItems {
    ...
    public static final ItemEntry<RecordItem> MUSIC_DISC_ELEVATOR =
            REGISTRATE.item("music_disc_elevator", properties -> new RecordItem(15, CCSoundEntries.ELEVATOR_MUSIC.getMainEvent(), properties, 4820))
    ...
    public static final ItemEntry<RecordItem> MUSIC_DISC_INTERLUDE =
            REGISTRATE.item("music_disc_interlude", properties -> new RecordItem(14, CCSoundEntries.INTERLUDE_MUSIC.getMainEvent(), properties, 3800))
                    .properties(p -> p.stacksTo(1).rarity(Rarity.RARE))
                    .tag(ItemTags.MUSIC_DISCS)
                    .lang("Music Disc")
                    .register();
